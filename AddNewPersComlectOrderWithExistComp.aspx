<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewPersComlectOrderWithExistComp.aspx.cs" Inherits="AddNewPersComlectOrder" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <User:AddPersComlectedOrderControl id="AddPersComlectedOrderControl" runat="server" addToRegisteredCompany="true" />
</asp:Content>
