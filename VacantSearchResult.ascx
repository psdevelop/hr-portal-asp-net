                ...
                <tr>
                  ...
                  <td align="left">
                    Зарплата&nbsp; 
                      ...
                      <A href="mailto:email?subject=Message from RABOTA-YUG.RU&body='<%# Eval("EcpecProfName") %>'" mce_href="mailto:email?subject=Message from RABOTA-YUG.RU&body='<%# Eval("EcpecProfName") %>'">Отослать другу</A>
                  </td>
                </tr>
              </table>
            </td>
